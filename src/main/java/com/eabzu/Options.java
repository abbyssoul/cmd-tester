...
public class Options {
	...
	@Parameter(names = {"-h", "--help"}, help = true, description = "Show command line options")
	...
	@Parameter(names = "--headless", description = "Do NOT show GUI if this option is given", arity = 1)
